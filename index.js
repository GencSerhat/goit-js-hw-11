import{i as l,S as u}from"./assets/vendor-5ObWk2rO.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function e(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(t){if(t.ep)return;t.ep=!0;const r=e(t);fetch(t.href,r)}})();console.log("merhaba");const d="48479056-b624f953eac1ddf8407abd187",f="https://pixabay.com/api/",p=document.querySelector(".search-input"),h=document.querySelector(".search-btn"),i=document.querySelector(".images-container"),c=document.querySelector(".loader");h.addEventListener("click",()=>{const o=p.value.trim();o?m(o):l.warning({message:"Please enter a search term.",position:"topRight"})});function m(o){const n=`${f}?key=${d}&q=${encodeURIComponent(o)}&image_type=photo&orientation=horizontal&safesearch=true`;c.style.visibility="visible",i.innerHTML="",setTimeout(()=>{fetch(n).then(e=>{if(!e.ok)throw new Error("API isteği başarısız oldu");return e.json()}).then(e=>{e.hits.length>0?g(e.hits):l.error({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight"})}).catch(e=>{console.log("Hata : ",e),i.innerHTML="<p>Bir hata oluştu lütfen tekrar deneyin </p>"}).finally(()=>{c.style.visibility="hidden"})},500)}function g(o){i.innerHTML=o.map(e=>`
